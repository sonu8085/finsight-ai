...
**API docs (Swagger):** https://finsight-ai-qxv4.onrender.com/docs

> Note: the backend is hosted on Render's free tier and spins down after periods of inactivity — the first request after a while may take 30–60 seconds to respond while it wakes up.
...
*Built as a portfolio project demonstrating full-stack development with a decoupled API/SPA architecture, async Python, and practical AI integration.*
